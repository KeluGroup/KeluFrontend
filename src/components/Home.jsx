      ...
      <div className="home-inner">
        ...
        <div className="home-copy">
          ...
          <div className="cta-row">
            <a href="/contact" className="btn-ph btn-ph-primary" onClick={() => trackCTAClick('hero-contact')}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M5 12h14M12 5l7 7-7 7"/>
              </svg>
              {t('home.cta')}
            </a>
            <Link to="/benefits" className="btn-ph btn-ph-ghost" onClick={() => trackCTAClick('hero-catalogue')}>
              {t('home.ctaSecond')}
            </Link>
          </div>
